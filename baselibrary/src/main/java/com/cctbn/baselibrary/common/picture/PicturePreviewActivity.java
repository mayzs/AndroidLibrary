...
import com.cctbn.baselibrary.common.picture.adapter.SimpleFragmentAdapter;
import com.cctbn.baselibrary.common.picture.anim.OptAnimationLoader;
...
import com.cctbn.baselibrary.common.picture.tools.VoiceUtils;
import com.cctbn.baselibrary.common.picture.widget.PreviewViewPager;
...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    private void singleRadioMediaImage() {
        if (selectImages != null
            ...
            EventBus.getDefault().post(new EventEntity(PictureConfig.UPDATE_FLAG,
